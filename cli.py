...
{Colors.BOLD}Usage:{Colors.END}
  ...
  for physiotherapy and medical education.
  
{Colors.BOLD}Examples:{Colors.END}
  - "Quali sono i test per la sindrome da impingement della spalla?"
  - "Parlami della riabilitazione dopo un intervento al legamento crociato anteriore"
  - "Confronta la terapia manuale e la tecarterapia per il dolore lombare"
"""
        print(help_text)
    ...
    async def run(self):
        ...
        print(f"{Colors.GREEN}Ready to chat! Ask me about physiotherapy and medical topics.{Colors.END}\n")
